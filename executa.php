...
$solucoes ['C-CarlosAlves']			= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C-CarlosAlves','env'=>[], 'language'=>'C','creator'=>'Carlos Alves','source'=>'https://github.com/OsProgramadores/op-desafios/tree/master/desafio-05/cbcalves/c/v1', 'serious'=>TRUE];
$solucoes ['C-CarlosAlves-V2']			= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C-CarlosAlves-2','env'=>[], 'language'=>'C','creator'=>'Carlos Alves','source'=>'https://github.com/OsProgramadores/op-desafios/tree/master/desafio-05/cbcalves/c/v2', 'serious'=>TRUE];
...
#$solucoes ['Php-Bcampos']				= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/php Exec/Php-Bcampos_V2.php', 'env'=>[], 'language'=>'Php', 'creator'=>'Bernardino Campos', 'source'=>'https://github.com/BernardinoCampos/Desafio5/blob/master/Desafio5.php', 'serious'=>TRUE];
#$solucoes ['Php-Mockba-7,3']			= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/php Exec/Php-Mockba2.php','env'=>[], 'language'=>'Php','creator'=>'Mockba - The Borg','source'=>'https://github.com/BernardinoCampos/Desafio5/blob/master/Desafio5_V4.php', 'serious'=>TRUE];
#$solucoes ['Php-Mockba-V4a']			= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/php Exec/Php-Mockba4a.php', 'env'=>[], 'language'=>'Php','creator'=>'Mockba - The Borg','source'=>'https://github.com/BernardinoCampos/Desafio5/blob/master/Desafio5_V4a.php', 'serious'=>TRUE];
...
#$solucoes ['Scala-Lucena']				= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/scala Exec/Scala-Lucena.jar','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Java','creator'=>'Leonardo Lucena','source'=>'', 'serious'=>TRUE];
#$solucoes ['NodeJS-BrunoSana']			= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/scala Exec/Js-BrunoSana.js','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'JavaScript','creator'=>'Bruno Sana','source'=>'', 'serious'=>TRUE];
