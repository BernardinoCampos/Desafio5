...
$solucoes ['Php-Mockba-V5']				= ['exec'=>'/usr/bin/php Exec/Php-Mockba3.php', 'env'=>[], 'language'=>'Php','creator'=>'Mockba - The Borg','source'=>'https://github.com/BernardinoCampos/Desafio5/blob/master/Desafio5_V4a.php', 'serious'=>TRUE];
