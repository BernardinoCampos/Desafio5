...
#$solucoes ['C++-JonathasValeriano']	= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C++-JonathasValeriano 8 ', 'env'=>['GOGC'=>'off'], 'language'=>'C++','creator'=>'Jonathas Valeriano','source'=>'https://github.com/OsProgramadores/op-desafios/tree/master/desafio-05/JonathasValeriano/cpp', 'serious'=>TRUE];
...
#$solucoes ['C++-LuizFelmach']				= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C++-LuizFelmach ', 'env'=>['GOGC'=>'off'], 'language'=>'C++','creator'=>'Luiz Felmach','source'=>NULL, 'serious'=>TRUE];
...
#$solucoes ['C-PedroExpedito']			= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C-PedroExpedito','env'=>[], 'language'=>'C','creator'=>'Pedro Expedito','source'=>'https://github.com/OsProgramadores/op-desafios/blob/master/desafio-05/pedroexpedito', 'serious'=>TRUE];
#$solucoes ['C-JoaoJMGoncalves']			= ['dir'=>'/OsProgramadores', 'exec'=>'./Exec/C-JoaoJMGoncalves','env'=>[], 'language'=>'C','creator'=>'João J.M. Gonçalves','source'=>'https://github.com/OsProgramadores/op-desafios/blob/master/desafio-05/jjmg-eng', 'serious'=>TRUE];
...
#$solucoes ['Java-PedroExpedito']		= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/java -cp Exec/Java-PedroExpedito.jar com.pedroexpedito.desafio05.Main','env'=>['LANG'=>'en_US.UTF-8'], 'language'=>'Java','creator'=>'Pedro Expedito','source'=>'', 'serious'=>TRUE];
...
#$solucoes ['Php-AlcioneFerreira']		= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/php Exec/Php-AlcioneFerreira.php', 'env'=>[], 'language'=>'Php','creator'=>'Alcione Ferreira','source'=>'', 'serious'=>TRUE];
...
#$solucoes ['Python-MarcelloBatiista']	= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-MarcelloBatiista.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Marcello Batiista','source'=>'', 'serious'=>TRUE];
#$solucoes ['Python-AnthonyFisicaBsb']	= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-AnthonyFisicaBsb.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Anthony Louis','source'=>'https://github.com/OsProgramadores/op-desafios/tree/master/desafio-05/anthonyfisicabsb/python', 'serious'=>TRUE];
#$solucoes ['Python-ThiagoSouza']		= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-ThiagoSouza.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Thiago Souza','source'=>'', 'serious'=>TRUE];
#$solucoes ['Python-JeffersonTeixeira']		= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-JeffersonTeixeira.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Jefferson Teixeira','source'=>'', 'serious'=>TRUE];
$solucoes ['Python-GabrielRocha']		= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-GabrielRocha.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Gabriel Rocha','source'=>'', 'serious'=>TRUE];
