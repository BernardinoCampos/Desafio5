...
$solucoes ['Python-AnthonyFisicaBsb']	= ['dir'=>'/OsProgramadores', 'exec'=>'/usr/bin/python3 Exec/Python-AnthonyFisicaBsb.py','env'=>['LC_ALL'=>'en_US.utf8'], 'language'=>'Python','creator'=>'Anthony Louis','source'=>'', 'serious'=>TRUE];
